...
import com.hexalitics.miplibrary.util.ExifDataCopier
import com.hexalitics.miplibrary.util.FileUriUtils
    ...
    fun compress(uri: Uri, outputFormat: Bitmap.CompressFormat?) {
        activity.lifecycleScope.launch {
            ...
            if (res != null) {
                ...
                setError(com.hexalitics.miplibrary.R.string.error_failed_to_compress_image)
            }
        }
    }
