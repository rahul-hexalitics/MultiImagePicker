package com.hexalitics.miplibrary
...
import com.hexalitics.miplibrary.listener.DismissListener
import com.hexalitics.miplibrary.listener.ResultListener
import com.hexalitics.miplibrary.util.DialogHelper
import java.io.File
...
open class ImagePicker {
    ...
    companion object {
        ...
        internal const val EXTRA_MAX_COUNT = "extra.max_count"
    ...
    class Builder(private val activity: Activity) {
        ...
        fun setMaxCount(count: Int): Builder {   // 👈 new method
            this.maxCount = count
            return this
        }
        ...
        private fun getBundle(): Bundle {
            return Bundle().apply {
                ...
                putInt(EXTRA_MAX_COUNT, maxCount)
